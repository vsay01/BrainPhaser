...
import com.questions.game.activities.BrainPhaserFragment;
...
public abstract class AnswerFragment extends BrainPhaserFragment {
    ...
    public enum ContinueMode {
         ...
         * {@link com.questions.game.activities.playchallenge.AnswerFragment.AnswerListener#onAnswerChecked(boolean, boolean)}
         */
        CONTINUE_HIDE_FAB,
